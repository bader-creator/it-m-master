...
public static $roles = array(
    'Noeuds d\'acceptances' => array(
        ...
        'modifier une réponse'  => 'ROLE_MODIFIER_REPONSE',
        'Affichage des commentaires' => 'ROLE_AFFICHER_COMMENTAIRE',
        'Affichage des réponses' => 'ROLE_AFFICHER_REPONSE',
        'Affichage des photos' => 'ROLE_AFFICHER_PHOTO',
        'Générer un pdf' => 'ROLE_GENERATE_PDF',
        'Générer un csv' => 'ROLE_GENERATE_CSV',
        'Générer un csv noeud acceptance' => 'ROLE_GENERATE_CSV_NOEUDACCEPTANCE',
        'Affichage Map' =>  'ROLE_AFFICHER_MAP'      
      ),
