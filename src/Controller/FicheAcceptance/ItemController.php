...
class ItemController extends AbstractController {
    ...
    public function index(Request $request,PaginatorInterface $paginator){
        ...
        $query = $em->getRepository(Item::class)->findBySearchInput($search_input);
        ...
        return $this->render('FicheAcceptance/item/index.html.twig',[
            'current_menu'=>'item',
            'items'=>$pagination,
    ...
    /**
     * @Route("/add_item", name="add_item_page")
     */
    public function add(Request $request,PaginatorInterface $paginator){
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            return $this->redirectToRoute('item_page',array('selected_row'=>$item->getId()));
        }
...
hello
    ...
    /**
     * @Route("/edit_item/{id}", name="edit_item_page")
     */
    public function update(Request $request,PaginatorInterface $paginator,$id){
        ...
        if(!$item){
            ...
            return $this->redirectToRoute('item_page');
        }
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            return $this->redirectToRoute('item_page',array('selected_row'=>$item->getId(),'search_input'=>$search_input,'page'=>$page));
        }
