...
class SiteController extends AbstractController {
    ...
    public function index(Request $request,PaginatorInterface $paginator){
        ...
        $query = $em->getRepository(Site::class)->findBySearchInput($search_input);
        ...
        return $this->render('Noeud/site/index.html.twig',[
            'current_menu'=>'site',
            'sites'=>$pagination,
    ...
    /**
     * @Route("/add_site", name="add_site_page")
     */
    public function add(Request $request,PaginatorInterface $paginator){
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            return $this->redirectToRoute('site_page',array('selected_row'=>$site->getId()));
        }
...
hello
    ...
    /**
     * @Route("/edit_site/{id}", name="edit_site_page")
     */
    public function update(Request $request,PaginatorInterface $paginator,$id){
        ...
        if(!$site){
            ...
            return $this->redirectToRoute('site_page');
        }
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            return $this->redirectToRoute('site_page',array('selected_row'=>$site->getId(),'search_input'=>$search_input,'page'=>$page));
        }
    ...
    /**
     * @Route("/delete_site",name="delete_site")
     */
